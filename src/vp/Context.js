...
const contextAwareLogger = (state, log) => ({
  silly: (...args) => log.silly(...args, { externalId: state.externalId }),
  debug: (...args) => log.debug(...args, { externalId: state.externalId }),
  info: (...args) => log.info(...args, { externalId: state.externalId }),
  warn: (...args) => log.warn(...args, { externalId: state.externalId }),
  error: (...args) => log.error(...args, { externalId: state.externalId }),
});
